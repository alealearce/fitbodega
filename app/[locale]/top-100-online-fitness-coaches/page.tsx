...
import data from "@/data/top-100/coaches.json";
...
const PAGE_TITLE = "Top 100 Online Fitness Coaches 2026";
const PAGE_DESC =
  "The best online fitness coaches you can actually hire, ranked by the Coaching Influence Score — coaching depth, content, reach, credibility, business, and engagement. Includes podcasts and creators with real coaching arms. Reviewed monthly.";

export const metadata: Metadata = {
  title: PAGE_TITLE,
  description: PAGE_DESC,
  alternates: { canonical: `${SITE.url}/top-100-online-fitness-coaches` },
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESC,
    url: `${SITE.url}/top-100-online-fitness-coaches`,
...
export default function Top100OnlineFitnessCoachesPage() {
    ...
    <details key={e.rank} className="group">
      <summary className="list-none [&::-webkit-details-marker]:hidden cursor-pointer select-none flex items-baseline gap-4 lg:gap-6 py-5 px-6 lg:px-8 -mx-6 lg:-mx-8 hover:bg-surface-low transition-colors duration-300">
        ...
        <span className="min-w-0 flex-1 flex flex-wrap items-baseline gap-x-3 gap-y-1">
          ...
          {e.tier === "media" && (
            <span className="font-sans text-label-sm uppercase text-primary">Media</span>
          )}
        </span>
        <span
      ...
      <div className="pb-8 pt-1 pl-12 lg:pl-14 pr-2 max-w-3xl">
        ...
        {e.tier === "media" && (
          <p className="font-sans text-sm text-on-surface-variant mb-3 flex items-start gap-2">
            <Mic size={14} className="flex-shrink-0 mt-0.5 text-primary" aria-hidden />
            Media brand with a genuine coaching arm — that arm is what qualifies it here.
          </p>
        )}
  ...
  return (
    <main className="bg-bg">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-24 bg-bg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h1 className="font-serif text-display-lg lg:text-display-xl uppercase tracking-tight text-on-surface max-w-5xl">
            Top 100 Online Fitness <span className="text-primary">Coaches</span> 2026
          </h1>
      ...
      <SeriesLinks current="/top-100-online-fitness-coaches" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-primary px-8 py-12 lg:px-14 lg:py-16">
            <h2 className="font-serif text-display-md uppercase text-primary-on max-w-2xl">
              Coach online and belong here?
            </h2>
            <p className="font-sans text-base text-primary-on/80 mt-4 max-w-xl">
              The ranking is reviewed {meta.reviewCadence}. Corrections, disputes, and coaches we
              should be tracking:{" "}
