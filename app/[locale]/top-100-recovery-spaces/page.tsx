...
import data from "@/data/top-100/recovery.json";
...
const PAGE_TITLE = "Top 100 Recovery Spaces 2026 — Spas, Saunas & Bathhouses";
const PAGE_DESC =
  "The world's best recovery spaces, ranked by the Recovery Space Score — legacy, experience, facility, community, reach, and destination pull. Bathhouses, saunas, thermal lagoons, and modern recovery clubs. Reviewed monthly.";

export const metadata: Metadata = {
  title: PAGE_TITLE,
  description: PAGE_DESC,
  alternates: { canonical: `${SITE.url}/top-100-recovery-spaces` },
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESC,
    url: `${SITE.url}/top-100-recovery-spaces`,
...
export default async function Top100RecoverySpacesPage() {
  const meta = data.meta as unknown as Meta;
  const entries = data.entries as unknown as LedgerEntry[];
  const claimed = await getClaimedMap("recovery");
  ...
  return (
    <main className="bg-bg">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-24 bg-bg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h1 className="font-serif text-display-lg lg:text-display-xl uppercase tracking-tight text-on-surface max-w-5xl">
            Top 100 <span className="text-primary">Recovery</span> Spaces 2026
          </h1>
      ...
      <SeriesLinks current="/top-100-recovery-spaces" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-primary px-8 py-12 lg:px-14 lg:py-16">
            <h2 className="font-serif text-display-md uppercase text-primary-on max-w-2xl">
              Run a recovery space that belongs here?
            </h2>
            <p className="font-sans text-base text-primary-on/80 mt-4 max-w-xl">
              The ranking is reviewed {meta.reviewCadence}. Corrections, disputes, and venues we
              should be tracking:{" "}
