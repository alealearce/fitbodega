...
import data from "@/data/top-100/nutritionists.json";
...
const PAGE_TITLE = "Top 100 Nutritionists 2026";
const PAGE_DESC =
  "The world's leading credentialed nutritionists and dietitians, ranked by the Nutrition Authority Score — credibility, practice, content, reach, impact, and consistency. Sports RDs, researchers, and clinical leaders. Reviewed monthly.";

export const metadata: Metadata = {
  title: PAGE_TITLE,
  description: PAGE_DESC,
  alternates: { canonical: `${SITE.url}/top-100-nutritionists` },
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESC,
    url: `${SITE.url}/top-100-nutritionists`,
...
export default async function Top100NutritionistsPage() {
  const meta = data.meta as unknown as Meta;
  const entries = data.entries as unknown as LedgerEntry[];
  const claimed = await getClaimedMap("nutritionists");
    ...
    <main className="bg-bg">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-24 bg-bg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h1 className="font-serif text-display-lg lg:text-display-xl uppercase tracking-tight text-on-surface max-w-5xl">
            Top 100 <span className="text-primary">Nutritionists</span> 2026
          </h1>
      ...
      <section className="py-20 lg:py-24 bg-bg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <Top100Ledger
            entries={entries}
            claim={{ list: "nutritionists", claimed }}
            config={{
              scoreName: meta.scoreModel.name,
              kicker: "Steal this",
              tierChips: { researcher: "Researcher" },
            }}
          />
        </div>
      </section>
      ...
      <SeriesLinks current="/top-100-nutritionists" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-primary px-8 py-12 lg:px-14 lg:py-16">
            <h2 className="font-serif text-display-md uppercase text-primary-on max-w-2xl">
              Credentialed and belong here?
            </h2>
            <p className="font-sans text-base text-primary-on/80 mt-4 max-w-xl">
              The ranking is reviewed {meta.reviewCadence}. Corrections, disputes, and
              practitioners we should be tracking:{" "}
            ...
            >
              List your practice on FitBodega
            </Link>
          </div>
        </div>
      </section>
